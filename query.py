...
tools = [
    ...
    Tool(
        name="web-search",
        func=web_search.run,
        description="Useful for when you need to look up the web, get up-to-date information, or when qa-enset doesn't prove useful. Always write the search query in french",
    ),
    Tool(
        name="qa-general",
